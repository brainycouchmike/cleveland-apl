...
(function($) {
    app = $.extend(true, {}, app, {
        // Public Properties
        inited: false,
        deviceReadyDeferred: app.deviceReadyDeferred || $.Deferred(),
        jqmReadyDeferred: app.jqmReadyDeferred || $.Deferred(),
    ...
    //            console.log(typeof($.mobile), $.mobile, typeof($.mobile.loader), $.mobile.loader);
        ...
        loadPetDetails: function() {
            ...
            $("#detailed-result").addClass("AJAXing").one("pageload", function() {
                $(this).find(".global-header a[data-rel='back']").one("tap.sudoBack",function(e) {
